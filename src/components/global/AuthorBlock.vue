    ...
    >
        ...
        <div class="author-metas pageHeader" v-if="orientation == 'pageHeader'">
            ...
            <div class="bio-content">
                ...
                <div class="socials">
                    <Link :to="info.meta.linkedin" v-if="info.meta.linkedin" do-open-in-new-tab>
                    ...
                    <Link :to="info.meta.github" v-if="info.meta.github" do-open-in-new-tab>
                        <svg width="23" height="23" viewBox="0 0 24 24">
                            ...
                            /></svg
                    ></Link>
                    <Link :to="info.meta.twitter" v-if="info.meta.twitter" do-open-in-new-tab>
                        <svg viewBox="0 0 448 512" width="24" height="24">
                            <path
